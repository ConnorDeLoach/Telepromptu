...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOutputText = (TextView) findViewById(R.id.main_activity_textview);
    ...
    public void buttonOnClickListener(View view) {
        Toast.makeText(this, "Read to start activity", Toast.LENGTH_LONG).show();
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        protected void onPostExecute(List<String> output) {
            ...
            if (output == null || output.size() == 0) {
                ...
                sharedPreferences.edit().putString("driveid", TextUtils.join(",", output)).apply();
